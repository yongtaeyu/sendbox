package com.example.sandbox.jwt;

import com.example.sandbox.exception.TokenInvalidExpiredException;
...
public class JwtTokenProvider {
    ...
    private void validateExpiredToken(final Jws<Claims> claims) {
        if (claims.getBody().getExpiration().before(new Date())) {
            throw new TokenInvalidExpiredException("TokenInvalidExpiredException");
        }
    }
